// Game Arcade 2026 yang sudah ditutup ("Game over!"), Januari–Agustus 2026.
// Sumber: section "Game over!" di go.cloudskillsboost.google/arcade (dicek ulang 2 Sep 2026).
...
export const PAST_GAMES = [
  // Januari
  // `alt` untuk game yang judul asli di profil beda: Google kadang pakai format "Work Meets Play:
  // <Tema>" untuk game spesial, bukan format "Arcade <Nama>" seperti di halaman arsip. Tanpa alias,
  // badge ini lolos dari isGame() dan kehitung sebagai skill/unknown -- lihat issue Leontinus di
  // masukan 16 Sep 2026.
  { m: 1, name: 'Arcade Work- Life Refresh', pts: 2, alt: ['Work Life Refresh'] },
  { m: 1, name: 'Arcade A Cloud That Cares', pts: 1, alt: ['Work Meets Play: A Cloud That Cares'] },
  { m: 1, name: 'Arcade Base Camp January', pts: 1, alt: ['Arcade Base Camp January 2026'] },
  { m: 1, name: 'Arcade Certification Zone', pts: 1, alt: ['Google Skills Arcade Certification Zone January 2026'] },
  ...
  // Februari
  { m: 2, name: 'Arcade From Foundation to Wonders', pts: 3, alt: ['From Foundations To Wonders'] },
  { m: 2, name: 'Arcade Skills At the Pitch', pts: 3, alt: ['Skills At The Pitch'] },
  { m: 2, name: 'Arcade Journey Made Easy', pts: 1, alt: ['Work Meets Play: Journeys Made Easy'] },
  ...
  // Maret
  { m: 3, name: 'Arcade Holi-Istic Infrastrectures', pts: 2, alt: ['Holi-istic Infrastructures'] },
  { m: 3, name: 'Arcade Matrics in Motion', pts: 3, alt: ['Work Meets Play: Metrics in Motion'] },
  ...
  // April
  { m: 4, name: 'Arcade Dialogue Design', pts: 1, alt: ['Dialogue Design'] },
  { m: 4, name: 'Arcade Skills Spawn', pts: 3, alt: ['Works Meet Play: Skills Spawn'] },
  ...
  // Mei
  { m: 5, name: 'Arcade Skill Up Summer', pts: 1, alt: ['Skill Up Summer'] },
  { m: 5, name: 'Arcade Expressive Efficiency', pts: 3, alt: ['Work Meets Play: Expressive Efficiency'] },
  ...
  // Agustus. Masuk daftar "Game over!" per 2 Sep 2026, termasuk Re-Trail (bonus run tengah bulan).
  // `alt` = judul badge bertema yang tersimpan di profil peserta (dari `title` GAME_CATALOG Agustus).
  { m: 8, name: 'Arcade Spans and Plans', pts: 1, alt: ['Spans and Plans'] },
  { m: 8, name: 'Arcade Simulator: Network Security Engineer', pts: 1 },
  { m: 8, name: 'Arcade Base Camp August', pts: 1, alt: ['Arcade Base Camp August 2026'] },
  { m: 8, name: 'Arcade Adventure: August 2026', pts: 1, alt: ['Arcade Adventure: Data Vault'] },
  { m: 8, name: 'Arcade Voyage: August 2026', pts: 1, alt: ['Arcade Voyage: Google Sheets'] },
  { m: 8, name: 'Arcade Trail: August 2026', pts: 1, alt: ['Arcade Trail: Cloud Delivery Systems'] },
  { m: 8, name: 'Arcade Re-Trail: August 2026', pts: 1, alt: ['Arcade Re-Trail: Vaults & Vectors'] },
]
...
// Set semua kunci (nama + alias) game terdahulu. Dipakai gameRules.isGame() supaya game yang
// sudah "Game over!" tetap terbaca game walau judulnya tidak memuat kata "Arcade" (mis. game
// spesial Agustus "Spans and Plans"). Tanpa ini, begitu bulan berganti, badge itu jatuh ke
// "skill"/unknown dan poinnya hilang diam-diam.
export const PAST_GAME_KEYS = new Set(PTS_BY_KEY.keys())
