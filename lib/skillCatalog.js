...
export const SKILL_CATALOG = [
  ...
  // Sesudah ini (4 Agu 2026) katalog = 93 badge, pas dengan daftar live Google. Batch
  // berikutnya menyusul di bawah.
  ...
  // Batch September 2026 (8 Sep): tiga badge live skills.google yang masuk lewat laporan peserta
  // ("badge selesai tapi tidak menambah poin"). 1842 dan 1736 sebelumnya tidak ada di katalog ini,
  // jadi badge yang di-earn tercatat sebagai "unknown badge" dan tidak berpoin; 1841 badge rilis
  // GEAR Agustus 2026. Id diverifikasi dari halaman live skills.google/course_templates/{id}.
  { id: 1841, name: 'Secure Agent Egress with Agent Gateway and Model Armor', since: '2026-09' },
  { id: 1842, name: 'Use Agent Skills with Multi-Agent Systems', since: '2026-09' },
  { id: 1736, name: 'Design and Implement Network Security in Google Cloud', since: '2026-09' },
  // PROVISIONAL, ditambahkan 20 Sep 2026 atas keputusan Ravi sambil menunggu jawaban resmi.
  // Tiga credential "Google Cloud Database Migrations" dihitung sebagai badge keahlian karena
  // kartu credential di skills.google menampilkan "SKILL BADGE - INTERMEDIATE" dan sebagian tool
  // komunitas (ArcadeCalc) menghitungnya, WALAUPUN data katalog Google menandainya
  // `credentialType: null` (bandingkan id 783 dan 629 yang tertulis `"skill_badge"`). Jadi ini
  // sengaja melawan data mentah Google, bukan kelalaian. Pertanyaan sudah dikirim ke
  // arcade-facilitator@google.com + arcade@dicoding.com (draft:
  // reference/email-arcade-skill-badge-2026-09-20.md).
  // KALAU JAWABANNYA "BUKAN badge keahlian": hapus ketiga entri ini lalu resync. Tanpa entri ini
  // badge-nya kembali ke kategori unknown dan 0 poin, jadi aman dibalik.
  // Sengaja tanpa `since`: ini bukan batch rilisan bulanan Google, jadi tidak boleh dapat chip
  // "BARU". Sengaja tanpa `level`: tes "17 badge per level" mengunci jumlah silabus.
  { id: 1560, name: 'Google Cloud Database Migrations: Strategy' },
  { id: 1637, name: 'Google Cloud Database Migrations: Homogeneous' },
  { id: 1659, name: 'Google Cloud Database Migrations: Heterogeneous' },
]
...
export const PROBLEM_BADGES = {
  ...
  1841: { why: 'Challenge lab-nya tidak bisa diakses.' },
}
...
const SKILL_ALIASES = {
  ...
  // GEAR memakai ejaan "Securing", judul live di skills.google "Secure". Course id tetap.
  1841: ['Securing Agent Egress with Agent Gateway and Model Armor'],
}
