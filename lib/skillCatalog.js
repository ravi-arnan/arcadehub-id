...
export const SKILL_CATALOG = [
  ...
  // JANGAN tambahkan "Google Cloud Database Migrations: Strategy/Homogeneous/Heterogeneous"
  // (id 1560/1637/1659) ke sini. Sempat masuk 20 Sep 2026 selama beberapa jam, lalu DICABUT
  // setelah Google Skills Support menjawab lewat arcade-facilitator@google.com: ketiganya
  // "are not Skill Badge courses", yang didapat peserta adalah Course Completion Badge. Skill
  // badge selalu punya challenge lab di learning path-nya (contoh: Manage Kubernetes in Google
  // Cloud). Ini juga sebabnya `credentialType` di katalog Google bernilai null untuk ketiganya,
  // sama seperti course biasa (bandingkan id 783/629 yang "skill_badge").
  // ArcadeCalc menghitungnya sebagai 0,5 poin, jadi kita memang berbeda dari tool itu di sini.
  // Lihat lib/scoring.test.mjs untuk tes yang menguncinya.
]
