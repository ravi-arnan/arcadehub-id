...
// "Work Life Refresh" adalah judul asli di profil untuk "Arcade Work- Life Refresh" (2 poin).
// Sebelum alias ini ada, badge itu tidak terbaca game sama sekali, jadi bukan cuma poinnya
// kurang tapi juga tidak mengisi syarat game milestone.
test('gamePoints: alias "Work Life Refresh" membawa bobot 2 poin, bukan default 1', () => {
  assert.equal(gamePoints('Work Life Refresh'), 2)
})
