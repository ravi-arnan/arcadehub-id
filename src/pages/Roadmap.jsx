...
const GROUPS = [
  {
    ...
    items: [
      ...
      { title: 'Cakupan tes diperluas', desc: 'Tes otomatis di luar logika poin: parsing profil (regex badge & tanggal), normalisasi URL + guard SSRF, matching katalog/alias, dan proyeksi milestone. 33 tes via node --test, ikut gate CI tiap push.' },
  ...
  },
  {
    ...
    items: [
      ...
      { title: 'Animasi pill navigasi', desc: 'Penanda menu aktif sekarang lompat, belum meluncur antar tab. Perlu naikkan fitur animasi layout atau tulis ulang pill-nya pakai CSS.' },
